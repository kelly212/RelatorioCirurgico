...
// PROCEDIMENTOS
const procedimentos = [
   {codigo: "PR1", descricao: "Abertura de apto arbitrario"},
   {codigo: "PR2", descricao: "Abertura de conjutiva limbar"},
   {codigo: "PR3", descricao: "Abertura de planos"},
   {codigo: "PR4", descricao: "Adaptação de lente terapeutica"},
   {codigo: "PR5", descricao: "Anestesia topica com colirio anestesico"},
   {codigo: "PR6", descricao: "Aplicaçao blefarostato"},
   {codigo: "PR7", descricao: "Aplicaçao colirio anestesico"},
   {codigo: "PR8", descricao: "Aplicaçao de blefarostato"},
   {codigo: "PR9", descricao: "Aplicaçao de injeçao intravitrea de (eylia ou ant vegf)"},
   {codigo: "PR10", descricao: "Aplicaçao de mitomicina 0,02% por 40 segundos"},
   {codigo: "PR11", descricao: "Aplicaçao do oculos de protecao"},
   {codigo: "PR12", descricao: "Aplicaçao do vigadexa colirio"},
   {codigo: "PR13", descricao: "Aplicaçao lente terapeutica"},
   {codigo: "PR14", descricao: "Aplicaçao pinça de calizio"},
   {codigo: "PR15", descricao: "Aplicaçao pomada cylocort"},
   {codigo: "PR16", descricao: "Assepsia e antssepsia"},
   {codigo: "PR17", descricao: "Aspiraçao do cortex"},
   {codigo: "PR18", descricao: "Bloqueio periobulbar"},
   {codigo: "PR19", descricao: "Capsulorrexis"},
   {codigo: "PR20", descricao: "Confecçao do flep tarçal inferior"},
   {codigo: "PR21", descricao: "Curativo"},
   {codigo: "PR22", descricao: "Curativo oclusivo"},
   {codigo: "PR23", descricao: "Curativo se necessario"},
   {codigo: "PR24", descricao: "Curetagem"},
   {codigo: "PR25", descricao: "Disecçao de conjutiva bulbar"},
   {codigo: "PR26", descricao: "Disesçao dermica e cauterizaçao"},
   {codigo: "PR27", descricao: "Disesçao em planos ate o musculo retrator de palpebras inferior"},
   {codigo: "PR28", descricao: "Disesçao em planos ate o periosteo"},
   {codigo: "PR29", descricao: "Disenserçao reto medial"},
   {codigo: "PR30", descricao: "Facoemulsificaçao luxaçao nucleo"},
   {codigo: "PR31", descricao: "Fotoablaçao com excimer laser"},
   {codigo: "PR32", descricao: "Implante lio intraocular"},
   {codigo: "PR33", descricao: "Infiltraçao anestesica de xylocaina com vaso"},
   {codigo: "PR34", descricao: "Infiltraçao subconjutiva de xylocaina com vaso"},
   {codigo: "PR35", descricao: "Isolamento do musculo retrator de palpebra inferior"},
   {codigo: "PR36", descricao: "Limpeza com soro fisiologico"},
   {codigo: "PR37", descricao: "Limpeza da cornea com soluçao fisiologica"},
   {codigo: "PR38", descricao: "Marcaçao dermica"},
   {codigo: "PR39", descricao: "Oclusor"},
   {codigo: "PR40", descricao: "Paracentese de camara anterior"},
   {codigo: "PR41", descricao: "Recuo mm do reto medial"},
   {codigo: "PR42", descricao: "Ressecçao da lesao"},
   {codigo: "PR43", descricao: "Ressecçao da lesao conjutival"},
   {codigo: "PR44", descricao: "Ressecçao do pterigio"},
   {codigo: "PR45", descricao: "Retirada de bolsões de gordura"},
   {codigo: "PR46", descricao: "Retirada de capsula"},
   {codigo: "PR47", descricao: "Retirada de corpo estranho"},
   {codigo: "PR48", descricao: "Retirada de material para anatomopatologico"},
   {codigo: "PR49", descricao: "Rotacao do retalho conjutival"},
   {codigo: "PR50", descricao: "Seccaço do musculo reto medial"},
   {codigo: "PR51", descricao: "Sondagem de vias lacrimais"},
   {codigo: "PR52", descricao: "Sutura"},
   {codigo: "PR53", descricao: "Sutura conjutival"},
   {codigo: "PR54", descricao: "Sutura de musculo retrator e tarço inferior"},
   {codigo: "PR55", descricao: "Sutura de planos"},
   {codigo: "PR56", descricao: "Sutura de planos dermicos"},
   {codigo: "PR57", descricao: "Sutura do flep tarçal ate o periosteo"},
   {codigo: "PR58", descricao: "Sutura do musculo na esclera"}
];
...
const tiposCirurgia = [
   {
      ...
      procedimentos: ["PR16", "PR6", "PR7", "PR9"]
   },
   {
   ...
   },
   {
      ...
      procedimentos: ["PR16", "PR8", "PR7", "PR40", "PR19", "PR30", "PR17", "PR32", "PR52", "PR11"]
   },
   {
   ...
   },
   {
      ...
      procedimentos: ["PR16", "PR33", "PR42", "PR48", "PR55"]
   },
   {
   ...
   },
   {
      ...
      procedimentos: ["PR16", "PR8", "PR34", "PR25", "PR43", "PR48", "PR55", "PR22"]
   },
   {
      codigo: "BL01", descricao: "Blefaroplastia", dados: blefero,
      procedimentos: ["PR38", "PR16", "PR33", "PR26", "PR1", "PR45", "PR55", "PR15"]
   },
   {
      codigo: "ES01", descricao: "Estrabismo", dados: estrabismo,
      procedimentos: ["PR16", "PR18", "PR2", "PR50", "PR29", "PR41", "PR58", "PR53", "PR22"]
   },
   {
      codigo: "PT01", descricao: "Pterígio  & Autotransplante", dados: pterigio,
      procedimentos: ["PR16", "PR8", "PR34", "PR25", "PR44", "PR49", "PR53", "PR13", "PR39"]
   },
   {
   ...
   },
   {
      ...
      procedimentos: ["PR16", "PR33", "PR51", "PR3", "PR23"]
   },
   {
   ...
   },
   {
      ...
      procedimentos: ["PR16", "PR33", "PR14", "PR3", "PR24", "PR36", "PR46", "PR22"]
   },
   {
   ...
   {
      codigo: "PRK1",      descricao: "PRK-Refrativa",      dados: pkr_refativa, // não definido no array original
      procedimentos: ["PR16", "PR6", "PR5", "PR31", "PR10", "PR37", "PR12", "PR4", "PR39"]
   }
];
...
renderTable(dados.equipamentos, 'equip-table', false);
...
document.getElementById('tipoCirurgia').addEventListener('change', function () {
   ...
   // Exemplo de uso:
   const descricaoFormatada = gerarDescricaoFormatada(cirurgia.procedimentos);
   var resumo = document.getElementById("resumo");
   resumo.value = descricaoFormatada;
   autoResize(resumo);
...
function gerarDescricaoFormatada(codigosProcedimentos) {
   const procedimentosSelecionados = procedimentos.filter(proc =>
    codigosProcedimentos.includes(proc.codigo)
   );

   // Ordena pelos códigos na ordem fornecida (opcional)
   const procedimentosOrdenados = codigosProcedimentos
    .map(codigo => procedimentosSelecionados.find(proc => proc.codigo === codigo))
    .filter(proc => proc); // Remove undefined se algum código não existir

   // Cria uma lista numerada
   return procedimentosOrdenados
